        ...
        <div className="h-full px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to={createPageUrl(currentUser.role === 'Worker' ? 'Dashboard' : 'ManagerDashboard')} className="flex items-center gap-3">
              ...
              <svg
                viewBox="0 0 500 200"
                className="h-10 w-auto text-[#00352F]"
                fill="currentColor"
              >
                {/* Outer Circle */}
                <circle cx="100" cy="100" r="80" stroke="currentColor" strokeWidth="6" fill="none"/>

                {/* Škoda Winged Arrow Symbol */}
                <path d="M 100 50 L 120 80 L 115 85 L 100 70 L 85 85 L 80 80 Z" />
                <path d="M 70 65 L 50 85 L 55 90 Z" />
                <path d="M 130 65 L 150 85 L 145 90 Z" />
                <circle cx="100" cy="100" r="10" />
                <path d="M 50 110 L 150 110 L 145 115 L 55 115 Z" />
              </svg>
              <span className="text-xl font-semibold text-[rgb(var(--text-primary))] hidden sm:block">
                Archer
              </span>
            </Link>
          </div>
